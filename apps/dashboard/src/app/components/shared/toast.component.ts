...
@Component({
  ...
  template: `
    <div class="fixed top-4 right-4 z-50 space-y-2 w-full max-w-sm sm:max-w-md">
      <div 
        ...
        <div class="p-4">
          <div class="flex items-start">
            ...
            <div class="ml-3 flex-1 min-w-0">
              <p *ngIf="toast.title" class="text-sm font-medium text-gray-900 truncate">{{ toast.title }}</p>
              <p class="text-sm text-gray-500 break-words">{{ toast.message }}</p>
            </div>
